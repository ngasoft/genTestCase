...
act_func = {
    ...
    "action_Determine_baudrate" : determine_baudrate,
    ...
    "action_Flood_with_set_UDS_messages" : None, #udsflood,
    ...
    "action_Run_through_00_00_to_0A_FF__standard_" : None, #standardobd,
    "action_Run_through_0B_00_to_FF_FF__non_standard_" : None, #nonstandardobd,
    ...
    "action_Using_passive_monitoring" : None, #monitoring,
